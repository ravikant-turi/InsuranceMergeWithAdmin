...
<body class="bg-gray-100 pt-20 font-sans">
	<f:view>
		...
		<div class="max-w-5xl mx-auto px-4 pt-6 pb-2">
			<h2 class="text-2xl font-bold text-blue-800">Welcome Admin 👋</h2>
			<p class="text-gray-600 mt-1">Here are your core administrative
				controls.</p>
		</div>

		<!-- 🎛️ Control Panel -->
		<div class="max-w-6xl mx-auto px-4 py-6 mb-10">
			<h3 class="text-2xl font-bold text-gray-800 mb-6 text-center">Admin
				Actions</h3>
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
				...
				<h:form>
					<h:commandButton value="💊 Pharmacy Review" action="Approval"
		...
		<div class="max-w-4xl mx-auto px-4 mb-10">
			<div
				class="bg-gray-200 border-l-4 border-gray-500 p-4 rounded-lg shadow-sm">
				<p class="text-sm text-gray-700 italic">"Efficiency is doing
					things right; effectiveness is doing the right things." — Peter
					Drucker</p>
			</div>
		</div>
