	...
	<div class="table-container">
		<h:form>
			<h:dataTable value="#{reviewPharmacyController.paginatedPharmacies}"
				...
				<h:column>
					<f:facet name="header">
						<h:commandLink styleClass="ravi"
							action="#{reviewPharmacyController.sort('pharmacyId')}">
                Pharmacy ID
                <h:graphicImage
								rendered="#{reviewPharmacyController.ascending}"
								value="/resources/media/images/up-arrow.png"
								styleClass="sort-arrow" />
							<h:graphicImage
								rendered="#{not reviewPharmacyController.ascending}"
								value="/resources/media/images/down-arrow.png"
								styleClass="sort-arrow" />
						</h:commandLink>
					</f:facet>
               ...
               Name
				...
				<h:column>
					<f:facet name="header">
						<h:commandLink action="#{reviewPharmacyController.sort('aadhar')}">
                Aadhar
                <h:graphicImage
								rendered="#{ reviewPharmacyController.ascending}"
								value="/resources/media/images/up-arrow.png"
				...
				<h:column>
					<f:facet name="header">
						<h:commandLink  styleClass="ravi" action="#{reviewPharmacyController.sort('gstNo')}">
                GST Number
                <h:graphicImage
								rendered="#{ reviewPharmacyController.ascending}"
								value="/resources/media/images/up-arrow.png"
				...
				<h:column>
					<f:facet name="header">
						<h:commandLink action="#{reviewPharmacyController.sort('status')}">
                Status
                <h:graphicImage
								rendered="#{ reviewPharmacyController.ascending}"
								value="/resources/media/images/up-arrow.png"
