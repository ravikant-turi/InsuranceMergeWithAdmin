 ...
 *
 * <p>
 * This class initializes a singleton instance of SessionFactory using the
 * configuration provided in the `hibernate.cfg.xml` file. It provides a static
 * method to access the SessionFactory throughout the application.
 * </p>
 *
 * <p>
 * Logging is handled using Log4j to track the initialization process and
 * capture any errors during SessionFactory creation.
 * </p>
 *
